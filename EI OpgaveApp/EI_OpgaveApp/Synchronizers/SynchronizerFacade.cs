...
namespace EI_OpgaveApp.Synchronizers
{
    public class SynchronizerFacade
    {
        ...
        private AppErrorSynchronizer appErrorSynchronizer;
        private FixedAssetSynchronizer fixedAssetSynchronizer;
        private ResourcePersonSynchronizer resourcePersonSynchronizer;
        private WorkTypeSynchronizer workTypeSynchronizer;
        ...
        public AppErrorSynchronizer AppErrorSynchronizer
        {
            get
            {
                if (appErrorSynchronizer == null)
                {
                    appErrorSynchronizer = new AppErrorSynchronizer();
                }
                return appErrorSynchronizer;
            }
        }
        public FixedAssetSynchronizer FixedAssetSynchronizer
        {
            get
            {
                if (fixedAssetSynchronizer == null)
                {
                    fixedAssetSynchronizer = new FixedAssetSynchronizer();
                }
                return fixedAssetSynchronizer;
            }
        }
        public WorkTypeSynchronizer WorkTypeSynchronizer
        {
            get
            {
                if (workTypeSynchronizer == null)
                {
                    workTypeSynchronizer = new WorkTypeSynchronizer();
                }
                return workTypeSynchronizer;
            }
        }
        public ResourcePersonSynchronizer ResourcePersonSynchronizer
        {
            get
            {
                if (resourcePersonSynchronizer == null)
                {
                    resourcePersonSynchronizer = new ResourcePersonSynchronizer();
                }
                return resourcePersonSynchronizer;
            }
        }
    }
}
