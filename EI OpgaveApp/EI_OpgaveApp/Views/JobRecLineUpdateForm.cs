...
namespace EI_OpgaveApp.Views
{
    public class JobRecLineUpdateForm : ContentPage
    {
        ...
        public JobRecLineUpdateForm(JobRecLine jobRecLine)
        {
            ...
            workTypeButton = new Button { Text = "Arbejdstype (" + recLineGlobal.Work_Type + ")", BackgroundColor = Color.FromRgb(135, 206, 250), TextColor = Color.White };
        ...
        private void Done_Clicked(object sender, EventArgs e)
        {
            ...
            {
                SetRecLineValues();
                Debug.WriteLine("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!" + recLine.TimeRegGUID);
        ...
        private void SetRecLineValues()
        {
            ...
            recLineGlobal.Start_Time = datePicker.Date;
        ...
        private async void WorkTypeButton_Clicked(object sender, EventArgs e)
        {
            ...
            recLineGlobal.Work_Type = workType;
